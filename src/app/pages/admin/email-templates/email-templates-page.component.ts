...
@Component({
  ...
  imports: [NgIcon, RichTableComponent, ...HlmCardImports, ...HlmIconImports, ...HlmInputGroupImports],
  providers: [
...
export class EmailTemplatesPageComponent implements OnInit, EmailTemplatesTableHost {
  ...
  async deleteTemplate(template: SaEmailTemplateSummaryDto): Promise<void> {
    const name = this.displayName(template);
